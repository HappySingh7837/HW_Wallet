...
const SendWallet = ({}: Props) => {
  ...
  const handleSelectAll = () => {
    const makeAllSelected = transectionData.map((item: any) => ({
      ...item,
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollView}>
      ...
      <View style={styles.container}>
        ...
        <StyledButton title={lang.sendTransaction} onPress={() => {}} />
      </View>
    </ScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  amountInput: {
    width: windowWidth - Theme.sizes.size87,
    marginLeft: Theme.sizes.size10,
    transform: [{translateY: Theme.sizes.size20}],
  },
  slider: {
    width: windowWidth - Theme.sizes.size112,
  },
  lowerContainer: {
    marginTop: Theme.sizes.size20,
  },
